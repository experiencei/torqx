  ...
  return (
    <>
      ...
      <div
        ...
        } fixed lg:sticky lg:top-0 top-0 left-0 h-screen w-64 lg:w-64
           bg-white dark:bg-black border-r border-border flex flex-col
           transition-all duration-300 z-50 lg:z-auto overflow-hidden`}
      >
        {/* Logo */}
                ...
                className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors whitespace-nowrap
                  ${
                    currentPage === item.id
                      ...
                      : 'text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white hover:bg-gray-100 dark:hover:bg-neutral-900'
                  }`}
              >
        ...
        <div className="p-4 border-t border-border">
          {/* User Info */}
          {user && (
            <div className="mb-4 p-3 bg-gray-100 dark:bg-neutral-900 rounded-lg">
          ...
          <div className="space-y-2">
            ...
            <Button
              ...
              size="sm"
              onClick={toggleTheme}
              className="w-full justify-start hover:bg-gray-100 dark:hover:bg-neutral-900 hover:text-black dark:hover:text-white"
            >
              {isDarkMode ? (
