...
export const AboutSection = () => {
  ...
  return (<div className="py-20 lg:py-28">
    ...
    <div className="mt-20  flex flex-col gap-8">
      <div className="grid grid-cols-1  gap-8 md:grid-col-5  lg:grid-cols-3 ">
      ...
      <CardHeader title="My Toolboxs"  description="Explore the technologies and tools I use to craft digital experiences" className="" />
      ...
      <div className="grid grid-cols-1  md:grid-col-5 lg:grid-cols-3 gap-8">
