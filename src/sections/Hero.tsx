...
import designExamle1Images from '@/assets/images/design-example-1.png';
import designExamle2Images from '@/assets/images/design-example-2.png';
    ...
    return (
        ...
        >
            <div className="container relative">
                ...
                <motion.div ref={rightDesignScope} initial={{opacity: 0 , y: 100 , x: 100}} drag className="absolute -rightt-64 -top-16 hidden lg:block">
                    <Image
                        src={designExamle2Images}
                ...
                <p className="text-center text-xl text-white/50 mt-8 max-w-2xl"> Designs tools shouldn't slow you down , 
                    Layers combines powerful features with an intuitive interface that keeps you
