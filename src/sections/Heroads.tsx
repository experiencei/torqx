              ...
              <div className="md:flex items-center ">
                  <div className="md:w-[478px]">
                    ...
                    <div className="flex gap-1 items-center mt-[30px]">
                      ...
                      <Image src={ArrowIcon} className="h-5 w-5" alt="Arrow Icon"/>
                      </button>
                    </div>
                  </div>
                  <div className="mt-20 md:mt-0 md:h-[648px] md:flex-1 relative">
                    ...
                    />
                    <motion.img src={noodleImage.src} width={220} alt="Noodle Image" className="hidden lg:block absolute top-[524px] left-[448px] rotate-[30deg]"
                       style={{
                        rotate: 30,
                        translateY: translateY,
                      }}
