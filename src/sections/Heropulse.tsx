...
export default function PulseHero() {
  ...
  return (
    <div className="font-primary sm:-py-20 relative min-h-screen w-full overflow-hidden bg-black text-white">
      {/* Background grid */}
      <svg
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 text-center">
        {/* Tagline */}
        <h2 className="font-mono text-xs font-light tracking-[0.2em] uppercase text-gray-400 md:text-sm">
        ...
        {/* Main headline */}
        <h1 className="mt-6 text-4xl font-semibold leading-tight md:text-6xl lg:text-7xl tracking-tight">
        ...
        {/* Subheading */}
        <p className="mt-6 max-w-2xl text-base font-light text-gray-300 md:text-lg">
          With Pulse, brands, agencies, and enterprises can launch and optimize
          DOOH & CTV campaigns in minutes—no scouting, no paperwork, no
          negotiations. Just smart, AI-powered advertising at scale.
        </p>

        {/* CTA */}
        <div className="mt-8 flex flex-wrap justify-center gap-4">
  {/* Start Campaign → Get Started for Free */}
  <Link
    href="/contact"
    className="inline-flex items-center justify-center rounded-full px-6 py-3 text-base font-semibold text-white border border-white shadow-md transition hover:bg-green-500 hover:text-white"
  >
    Start Campaign 
  </Link>

  {/* Request Demo → Calendly Popup */}
  {root && (
  <PopupButton
  url="https://calendly.com/ayelojahighbee01/30min"
  rootElement={document.body}
  text="Request Demo "
  className="inline-flex items-center justify-center rounded-full px-6 py-3 text-base font-semibold bg-white text-black shadow-md transition hover:bg-black/90 hover:text-white"
/>
)}
